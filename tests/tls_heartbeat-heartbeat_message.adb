package body TLS_Heartbeat.Heartbeat_Message is
   ...
   procedure Get_Padding (Buffer : Types.Bytes; First : out Types.Index_Type; Last : out Types.Index_Type) is
   begin
      First := Get_Padding_First (Buffer);
      Last := Get_Padding_Last (Buffer);
   end Get_Padding;
